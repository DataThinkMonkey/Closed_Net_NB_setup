...
* Script pcpi-prepare.sh is run which will crate ~/offline_assets child directories apt and pip.
* Add premade Notebooks to ~/offline_assets as notebooks.tar.gz.
...
* From in the ~/offline_assets directory on PC-pi Start python3 -m http.server 8080 to host repos
